...
import com.universe.kotlinytmusicscraper.encoder.brotli
import com.universe.kotlinytmusicscraper.models.Context
import com.universe.kotlinytmusicscraper.models.WatchEndpoint
import com.universe.kotlinytmusicscraper.models.YouTubeClient
import com.universe.kotlinytmusicscraper.models.YouTubeLocale
import com.universe.kotlinytmusicscraper.models.body.AccountMenuBody
import com.universe.kotlinytmusicscraper.models.body.BrowseBody
import com.universe.kotlinytmusicscraper.models.body.CreatePlaylistBody
import com.universe.kotlinytmusicscraper.models.body.EditPlaylistBody
import com.universe.kotlinytmusicscraper.models.body.FormData
import com.universe.kotlinytmusicscraper.models.body.GetQueueBody
import com.universe.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import com.universe.kotlinytmusicscraper.models.body.LikeBody
import com.universe.kotlinytmusicscraper.models.body.MusixmatchCredentialsBody
import com.universe.kotlinytmusicscraper.models.body.NextBody
import com.universe.kotlinytmusicscraper.models.body.NotificationBody
import com.universe.kotlinytmusicscraper.models.body.PlayerBody
import com.universe.kotlinytmusicscraper.models.body.SearchBody
import com.universe.kotlinytmusicscraper.models.body.spotify.CanvasBody
import com.universe.kotlinytmusicscraper.models.musixmatch.SearchMusixmatchResponse
import com.universe.kotlinytmusicscraper.utils.CustomRedirectConfig
import com.universe.kotlinytmusicscraper.utils.parseCookieString
import com.universe.kotlinytmusicscraper.utils.sha1
...
//            q_artist=culture+code,+james+roche+&+karra&q_track=make+me+move+(james+roche+remix)
    ...
    suspend fun checkForUpdate() =
        httpClient.get("https://api.github.com/repos/UniVerseCorp/AudioFlare/releases/latest") {
            contentType(ContentType.Application.Json)
        }
